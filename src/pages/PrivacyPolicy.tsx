        ...
        <div className="space-y-8">
          ...
          <div className="bg-card border border-primary/30 rounded-xl p-5">
            <p className="text-muted-foreground text-sm">
              This is a placeholder privacy policy for Stratosphere. It will be replaced with a
              full, legally reviewed policy before public launch.
            </p>
          </div>

          <Section title="1. Who we are">
            <p>
              Stratosphere ("we", "us") provides trading pattern analytics tools. You can reach us at{" "}
              <a href="mailto:hello@mamizm.com" className="text-primary hover:underline">
                hello@mamizm.com
              </a>
              .
            </p>
          ...
          <Section title="2. What data we collect">
            <ul className="space-y-3 list-none">
              <Li>
                ...
                <span className="text-muted-foreground">(only with your consent)</span>: page views,
                session duration, approximate location, device and browser type — collected via
                Google Analytics 4.
              </Li>
              <Li>
                <strong className="text-foreground">Technical data</strong>: standard server logs
                (IP address, user agent) used for security and debugging.
              </Li>
            </ul>
          </Section>
          ...
          <Section title="3. Cookies">
            <p className="mb-4">
              We use the following cookies only after you accept them in the cookie banner:
            </p>
            <div className="bg-background rounded-lg border border-border overflow-hidden">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left px-4 py-3 text-muted-foreground font-medium">Cookie</th>
                ...
                <tbody>
                  <tr className="border-b border-border/50">
                    <td className="px-4 py-3 font-mono text-xs text-primary">_ga</td>
                    <td className="px-4 py-3 text-muted-foreground">Google Analytics</td>
                    <td className="px-4 py-3 text-muted-foreground">2 years</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 font-mono text-xs text-primary">_ga_G-79NLZMQR16</td>
                    <td className="px-4 py-3 text-muted-foreground">Google Analytics</td>
                    <td className="px-4 py-3 text-muted-foreground">2 years</td>
                  </tr>
                </tbody>
          ...
          <Section title="4. Legal basis (GDPR)">
            <p>
              We process analytics data on the basis of your consent (Art. 6(1)(a) GDPR). You may
          ...
          <Section title="5. Data sharing">
            <p>
              Analytics data is processed by Google LLC (USA) under their Data Processing Terms.
          ...
          <Section title="6. Your rights">
            <p>
              ...
              lodge a complaint with your local data protection authority. Email{" "}
              <a href="mailto:hello@mamizm.com" className="text-primary hover:underline">
                hello@mamizm.com
              </a>{" "}
          ...
          <Section title="7. Changes">
            <p>
              We may update this policy. Significant changes will be announced on this page.
            </p>
          </Section>
